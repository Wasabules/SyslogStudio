...
func TestValidateServerConfig_InvalidPort(t *testing.T) {
	tests := []struct {
		...
		{"UDP port 0", ServerConfig{UDPEnabled: true, UDPPort: 0}},
		{"UDP port negative", ServerConfig{UDPEnabled: true, UDPPort: -1}},
		{"UDP port too high", ServerConfig{UDPEnabled: true, UDPPort: 70000}},
		{"TCP port 0", ServerConfig{TCPEnabled: true, TCPPort: 0}},
		{"TLS port 0", ServerConfig{TLSEnabled: true, TLSPort: 0, UseSelfSigned: true}},
	}
